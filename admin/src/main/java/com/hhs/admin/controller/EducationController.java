...
import com.hhs.service.EducationService;
...
public class EducationController {
	...
	private final static String path = "admin/education/";
	...
	@RequiresPermissions("admin:education:add")
	...
	public Map<String, Object> addAction(Education model)
	{
		Map<String, Object> map = new HashMap<>();
		if (educationService.save(model)) {
			map.put("status", "ok");
		} else {
			map.put("status", "no");
		}
	...
	@ResponseBody
	public Map<String, Object> updateAction(Education model)
	{
		Map<String, Object> map = new HashMap<>();
		if (educationService.update(model)) {
			map.put("status", "ok");
		} else {
			map.put("status", "no");
		}
	...
	@RequiresPermissions("admin:education:show")
	...
	public String manager(ModelMap map, @PathVariable Integer pageIndex, @PathVariable Integer pageSize,String k)
	{
		...
		Page<Education> list = educationService.list(dc, pageIndex, pageSize);
		map.put("page", list);
		map.put("path", path);
		map.put("key", k);
		return path + "list";
	...
	@RequiresPermissions("admin:education:delete")
	@RequestMapping("deleteById/{id}.json")
	@ResponseBody
	public Map<String, Object> delete(@PathVariable Integer id)
	{
		Map<String, Object> map = new HashMap<>();
		if (educationService.deleteById(id, false)) {
			map.put("status", "ok");
		} else {
			map.put("status", "no");
		}
	...
	public Map<String, Object> delete(@PathVariable String ids)
	{
    	...
    	if (educationService.deleteByIds(arrayId, false)) {
    		map.put("status", "ok");
    	} else {
    		map.put("status", "no");
    	}
	...
	{
        Map<String, Object> map = new HashMap<>();
		if (educationService.update(p, v, id)) {
			map.put("status", "ok");
		} else {
			map.put("status", "no");
		}
