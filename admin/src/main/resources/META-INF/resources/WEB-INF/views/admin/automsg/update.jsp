				...
				<div class="col-md-12">
					...
					<div class="box box-info">
							...
							<div class="col-sm-8">
								<select name="type.id" style="width: 100% !important;"
									...
									<c:forEach items="${typeList}" var="m">
										<option ${model.type.id==m.id?'selected':'' } value="${m.id}">
											${m.name}</option>
									</c:forEach>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.name}"
									placeholder="请输入问题" id="name" name="name" datatype="*"
									errormsg="请输入问题" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.keyz}"
									placeholder="关键字" id="keyz" name="keyz" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<script id="content" name="content" type="text/plain"
									class="ue-editor" style="width: 100%; height: 400px;"> ${model.content} </script>
							</div>
						</div>
