					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select name="member.id" style="width: 100% !important;"
										class="form-control select2" id="member">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="number" class="form-control" placeholder="余额来源"
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="获利总额"
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="账单总额"
										id="recordMoney" name="recordMoney" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div style="width: 65.5%; padding-left: 21px;"
								class="input-group date form_datetime1 col-md-5"
								data-date-format="yyyy-MM-dd HH:mm:ss"
								data-link-field="dtp_input1">
								<input style="background-color: white;" class="form-control"
									type="text" placeholder="获利时间" id="gainTime" name="gainTime"
							...
							<div class="box-body">
								<div class="form-group">
									...
									<div
										style="width: 65.5%; padding-left: 23px; background-color: white;"
										class="input-group date form_datetime1 col-md-5"
										data-date-format="yyyy-MM-dd HH:mm:ss"
										data-link-field="dtp_input1">
										<input style="background-color: white;" class="form-control"
											type="text" placeholder="交易时间" id="dealTime" name="dealTime"
											readonly> <span class="input-group-addon"> <span
											class="glyphicon glyphicon-remove"></span>
										</span> <span class="input-group-addon"> <span
											class="glyphicon glyphicon-th"></span>
									...
									<div class="box-body">
										<div class="form-group">
											...
											<div style="width: 66%; padding-left: 25px" class="col-sm-8">
												<input type="text" class="form-control" placeholder="交易详情"
