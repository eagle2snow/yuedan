                                    ...
                                    <c:forEach items="${page.list}" var="model">
                                        <tr>
                                            ...
                                            <td>${model.id}</td>
											 ...
											 <th>
                                                 <c:if test="${model.serve eq 1}">线下服务</c:if>
                                                 <c:if test="${model.serve eq 2}">电话咨询</c:if>
                                                 <c:if test="${model.serve eq 3}">视频咨询</c:if>
                                                 <c:if test="${model.serve eq 4}">线上服务</c:if>
                                             </th>

											 <th>${model.showPrice}</th>

											<th class="text-center"><img src='${model.imgerPath}'
...
<script>
    ...
    function edit(id) {
				...
				openPerRe("编辑服务分类表", 90, 90, '${adp}update/' + id + '.htm');
