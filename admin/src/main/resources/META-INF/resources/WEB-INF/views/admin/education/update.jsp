                        ...
                        <h3 class="box-title">编辑</h3>
                          ...
                          < /div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
											<label><input value="0"  ${model.level==0
                                                ?'checked':'' } type="radio" class="minimal" name="level"
                                                >初中</label>
											<label><input value="1"  ${model.level==1
                                                ?'checked':'' } type="radio" class="minimal" name="level"
                                                >高中</label>
											<label><input value="2"  ${model.level==2
                                                ?'checked':'' } type="radio" class="minimal" name="level"
                                                >中专</label>
											<label><input value="3"  ${model.level==3
                                                ?'checked':'' } type="radio" class="minimal" name="level"
                                                >大专</label>
											<label><input value="4"  ${model.level==4
                                                ?'checked':'' } type="radio" class="minimal" name="level"
                                                >本科</label>
											<label><input value="5"  ${model.level==5
                                                ?'checked':'' } type="radio" class="minimal" name="level"
                                                >硕士</label>
											<label><input value="6"  ${model.level==6
                                                ?'checked':'' } type="radio" class="minimal" name="level"
                                                >博士</label>
                                        </div>
                                    </div>
