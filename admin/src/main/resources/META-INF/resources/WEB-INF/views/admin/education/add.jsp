                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">添加</h3>
                          ...
                          <div class="col-sm-8">
											<label><input value="0" type="radio" class="minimal" name="level">初中</label>
											<label><input value="1" type="radio" class="minimal" name="level">高中</label>
											<label><input value="2" type="radio" class="minimal" name="level">中专</label>
											<label><input value="3" type="radio" class="minimal" name="level">大专</label>
											<label><input value="4" type="radio" class="minimal" name="level">本科</label>
											<label><input value="5" type="radio" class="minimal" name="level">硕士</label>
											<label><input value="6" type="radio" class="minimal" name="level">博士</label>
										</div>
									</div>
								</div>
								...
								<div class="box-body">
                                  <div class="form-group">
                                  <label class="col-sm-2 control-label">开学时间:</label>
                          <div style="width: 65.5%; padding-left: 21px;" class="input-group date form_datetime1 col-md-5" data-date-format="yyyy-MM-dd HH:mm:ss"
											data-link-field="dtp_input1">
                                                    <input style="background-color: white;"  class="form-control" type="text" placeholder="开学时间" id="startTime" name="startTime" readonly>
