                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">编辑</h3>
                          ...
                          < div class="col-sm-8" >
	                        ...
	                        <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">动态相册:</label>
                                    <div class="col-sm-8">
									
                                        <input class="file" type="file" id='dynamicImagesUrl'> <input
                                            value="${model.dynamicImagesUrl}"
                                            name="dynamicImagesUrl" id="dynamicImagesUrl_input" type="hidden"/>
                                        <div style="overflow: hidden;" class="dynamicImagesUrl">

                                            <div class="showimg-box pull-left">
                                                <div class="showimg">
                                                    <img src="${model.dynamicImagesUrl}" width="80" height="60"
                                                         onclick="adminShowPic(this)">
                                                </div>
                                                <span onclick="delPic(this,dynamicImagesUrl)"
