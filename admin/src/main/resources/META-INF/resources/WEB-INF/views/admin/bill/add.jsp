                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">添加</h3>
                          ...
                          <div class="col-sm-8">
											<label><input value="1" type="radio" class="minimal" name="form">金币</label>
											<label><input value="2" type="radio" class="minimal" name="form">砖石</label>
										</div>
									</div>
								</div>
                          ...
                          <div class="col-sm-8">
											<label><input value="1" type="radio" class="minimal" name="payPathway">支付宝</label>
											<label><input value="2" type="radio" class="minimal" name="payPathway">微信</label>
											<label><input value="3" type="radio" class="minimal" name="payPathway">约单</label>
										</div>
									</div>
								</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control"
                                               placeholder="收入来源" id="incomePathway" name="incomePathway"          />
                                    </div>
                                </div>
                            </div>
                          ...
                          <span class="input-group-addon">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control"
                                               placeholder="支出途径" id="expenditurePathway" name="expenditurePathway"          />
                                    </div>
                                </div>
                            </div>
