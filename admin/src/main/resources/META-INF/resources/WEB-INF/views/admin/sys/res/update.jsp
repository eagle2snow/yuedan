				...
				<div class="col-md-12">
					...
					<div class="box box-info">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"><i class="red">*</i>上级:</label>
							<div class="col-sm-8">
								<select name="parent.id" style="width: 100% !important;"
									class="form-control select2" id="parent">
									<c:forEach items="${parentList}" var="m">
										<option ${model.parent.id==m.id?'selected':'' }
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.name}"
									placeholder="名称" id="name" name="name" datatype="*"
									errormsg="请输入名称" />
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"><i class="red">*</i>权限值:</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.code}"
									placeholder="权限值" id="code" name="code" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<label><input value="1" ${model.type==1?'checked':'' }
									type="radio" class="minimal" name="type">菜单</label> <label><input
									value="2" ${model.type==2?'checked':'' } type="radio"
									class="minimal" name="type">按钮</label>
							</div>
						</div>
