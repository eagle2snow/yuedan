                                    ...
                                    <c:forEach items="${page.list}" var="model">
                                        <tr>
                                            ...
                                            <td>${model.id}</td>
											 ...
											 <th>${model.incomePathway}</th>

											 <th>${model.incomeTime}</th>

											 <th>${model.expenditure}</th>

											 <th>${model.expenditurePathway}</th>

											 <th>${model.expenditureTime}</th>
...
<script>
    ...
    function edit(id) {
				...
				openPerRe("编辑客户账单", 90, 90, '${adp}update/' + id + '.htm');
