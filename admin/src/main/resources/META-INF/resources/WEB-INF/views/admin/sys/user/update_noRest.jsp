			...
			<div class="col-md-12">
				<div class="box box-info">
					...
					<form class="form-horizontal" method="post" id="form-admin-add"
						action="${adp}updateNoRes.json">

						<input type="hidden" name="id" value="${model.id }"> <input
							name="password" type="hidden" value="${model.password }" />
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="请输入用户名"
										...
										${(model.username eq 'admin')? 'disabled':'' } id="username"
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="password" class="form-control"  autocomplete="off"
										placeholder="留空则不修改" id="newPass" name="newPass" />
								</div>
							</div>
