					...
					<div class="box-header with-border">
						<h3 class="box-title">编辑</h3>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.prices}"
								        	placeholder="价格" id="prices" name="prices" />
										</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.weights}"
								        	placeholder="重量" id="weights" name="weights" />
										</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.bulks}"
								        	placeholder="体积" id="bulks" name="bulks" />
										</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" value="${model.describes}"
							        placeholder="描述" id="describes" name="describes"           />
								</div>
							</div>
