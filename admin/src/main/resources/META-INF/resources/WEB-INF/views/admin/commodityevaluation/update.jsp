					...
					<div class="box-header with-border">
						<h3 class="box-title">编辑</h3>
										...
										<div class="col-sm-8">
											<select name="commodity.id" style="width: 100% !important;" class="form-control select2" id="commodity">
												<c:forEach items="${commodityList}" var="m">
													<option    ${model.commodity.id==m.id?'selected':'' }  value="${m.id}">
														${m.name}
													</option>
												</c:forEach> 
											</select>
										...
										<div class="col-sm-8">
											<select name="orderItem.id" style="width: 100% !important;" class="form-control select2" id="orderItem">
												<c:forEach items="${orderItemList}" var="m">
													<option    ${model.orderItem.id==m.id?'selected':'' }  value="${m.id}">
														${m.name}
													</option>
												</c:forEach> 
											</select>
										...
										<div class="col-sm-8">
											<select name="commodityAppraise.id" style="width: 100% !important;" class="form-control select2" id="commodityAppraise">
												<c:forEach items="${commodityAppraiseList}" var="m">
													<option    ${model.commodityAppraise.id==m.id?'selected':'' }  value="${m.id}">
														${m.name}
													</option>
												</c:forEach> 
											</select>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" value="${model.evaluationDetails}"
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" value="${model.replydetails}"
								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.audit}"
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.reply}"
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.browse}"
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.comment}"
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.praise}"
