                        ...
                        <h3 class="box-title">编辑</h3>
                          ...
                          < div class="col-sm-8" >
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="${model.serviceCharge}"
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
											<label><input value="1"  ${model.status==1
                                                ?'checked':'' } type="radio" class="minimal" name="status"
                                                >待审核</label>
											<label><input value="2"  ${model.status==2
                                                ?'checked':'' } type="radio" class="minimal" name="status"
                                                >拒绝提现</label>
											<label><input value="3"  ${model.status==3
                                                ?'checked':'' } type="radio" class="minimal" name="status"
                                                >待打款</label>
											<label><input value="4"  ${model.status==4
                                                ?'checked':'' } type="radio" class="minimal" name="status"
                                                >已打款</label>
											<label><input value="5"  ${model.status==5
                                                ?'checked':'' } type="radio" class="minimal" name="status"
                                                >已作废</label>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="operator" class="form-control"
                                                      id="operator" rows="3" placeholder="Enter ..."
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="remark" class="form-control"
                                                      id="remark" rows="3" placeholder="Enter ..."
