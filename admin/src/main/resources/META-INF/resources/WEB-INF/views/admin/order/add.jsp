                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">添加</h3>
                          ...
                          <div class="col-sm-8">
											<label><input value="1" type="radio" class="minimal" name="statusOrder">待应邀</label>
											<label><input value="2" type="radio" class="minimal" name="statusOrder">已应邀</label>
											<label><input value="3" type="radio" class="minimal" name="statusOrder">已成交</label>
											<label><input value="4" type="radio" class="minimal" name="statusOrder">已过期</label>
											<label><input value="5" type="radio" class="minimal" name="statusOrder">订单进行中</label>
										</div>
									</div>
								</div>
                          ...
                          <div class="col-sm-8">
											<label><input value="1" type="radio" class="minimal" name="statusPay">未付款</label>
											<label><input value="2" type="radio" class="minimal" name="statusPay">已付定金</label>
											<label><input value="3" type="radio" class="minimal" name="statusPay">已确认定金</label>
											<label><input value="4" type="radio" class="minimal" name="statusPay">待确认全款</label>
											<label><input value="5" type="radio" class="minimal" name="statusPay">已同意退款</label>
											<label><input value="6" type="radio" class="minimal" name="statusPay">已驳回退款</label>
										</div>
									</div>
								</div>
                          ...
                          <div class="col-sm-8">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control"
                                               placeholder="距离" id="distance" name="distance"          />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control"
                                               placeholder="服务时间" id="serviceTime" name="serviceTime"          />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control"
                                               placeholder="诚意金" id="earnestMoney" name="earnestMoney"          />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control"
                                               placeholder="订单总价" id="totalMoney" name="totalMoney"          />
                                    </div>
                                </div>
                            </div>
