                              ...
                              < option    ${model.client.id == m.id ? 'selected' : '' }  value="${m.id}">
                                  ${m.name}
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                   value="${model.rechargePathway}"
                                                   placeholder="充值方式" id="rechargePathway"
                                                   name="rechargePathway"/>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                   ...
                                                   placeholder="充值金额" id="totalMoney"
                                                   name="totalMoney"/>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                   value="${model.goldNumber}"
                                                   placeholder="金币数" id="goldNumber"
                                                   name="goldNumber"/>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                   value="${model.masonryNumber}"
                                                   placeholder="砖石数" id="masonryNumber"
                                                   name="masonryNumber"/>
                                        </div>
                                    </div>
