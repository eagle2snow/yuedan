                                    ...
                                    <div class="col-sm-6">
                                        <div class="cl pd-5 bg-1 bk-gray mt-20">
											<span class="l"><a href="javascript:;"
                                                ...
                                                id="count">${r"${page.count}"}</strong> 条
											</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div id="example1_filter" class="dataTables_filter">
                                            <div class="text-c">
                                                <input type="text" name="" id="key" placeholder="名称、介绍等"
                                                       ...
                                                       value='${r"${key}"}' style="width: 250px;height:33px"
                                                       class="input-text">
                                        ...
                                        <tr>
											...
											<#list list as f>
                                                <#if f.show?? >
                                                    ...
                                                    <#if f.type=='PICTURE' >
											<th class="text-center"><img src='${r"${model."}${f.fieldName}}'
                                                                         style="width: 50pxp; height: 50px;"/></th>

                                                    <#elseif f.type=='PICTURELIST'>
												<th width="120">

                                                    <c:forEach items='${r"${fn:split(model."}${f.fieldName},"|")}'
                                                               var='p'>
                                            ...
                                            <td>
                                                <javatime:format value="${r"${model.createTime}"}"
